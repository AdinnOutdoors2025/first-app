...
function NavbarMain1() {
        ...
        <div className="container navbar1">
            ...
            <div className={`nav-content21 ${isMenuOpen ? "open" : "notOpen"}`}>
                ...
                <div className="nav_container">
                   ...
                   <div className="home-cta-buttons-mobile">
    <a
        href="#ContactUsFooter"
        onClick={(e) => {
            e.preventDefault();
            document.getElementById('ContactUsFooter')?.scrollIntoView({
                behavior: 'smooth'
            });
        }}
    >
    ...
    <button className="book-btn" onClick={() => navigate("/book")}>
        <span className="book-btn-text">Book a site</span>
        <img
            src="/images/BookBtn_logo.png"
            alt="Image"
            className="book-btn-image"
            width="45"
            height="25"
        />
    </button>
