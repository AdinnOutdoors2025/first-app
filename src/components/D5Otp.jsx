...
//                     <div className='OTP_msg2'>Enter OTP sent to this 6453642433 </div>
//                     <div>
...
//                         <div className='Otp_enter1'></div> */}
//                     </div>
//                     <span className='Otp_resends2'>Enter a Correct OTP</span>
//                     <button className="continue-btn1">Verify</button>
