                        ...
                        <div className="row BookMain ">
                            ...
                            {currentProduct ? (
                                <div className="col-md-6 col-lg-6 Book-content2"  >
                                    ...
                                    <button className="btn-type">{currentProduct.category}</button>
                                    ...
                                    <button className='book-spot'>{currentProduct.productFrom} <span><img src='/images/Location_arrow.png' className='location-arrow'></img>  </span> {currentProduct.productTo}</button>
