...
//                        {/* <div className='otpBox' onClick={()=>navigate("/login3")}> */}
...
//                     <button type='submit' className="Submit-btn" onClick={()=>navigate("/login3")}>Submit OTP</button>
//                 </div>
//             </div>
//         </div>
//     );
