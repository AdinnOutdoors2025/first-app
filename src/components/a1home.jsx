...
function AdinnHome() {
  ...
  const dragItems = [
    ...
    { id: 4, name: "Innovation", image: "./images/what7.png", content: "Dynamic Lighting solutions make your ads stand out with moving lights, colour effects and we turn static visuals into eye catching experiences. It is perfect for events, billboards and building facades that grabs attention and enhances brand impact." },
    { id: 5, name: "Traditional", image: "./images/what4.png", content: "We provide high impactful Traditional ads through Billboards, Transit Media and Hoardings etc. We help your brand get noticed among the right people with the right placements. From Idea to Execution , we make sure your ads are clear and effective." },
