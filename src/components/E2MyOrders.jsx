                        ...
                        <div className='order-scroll'>
                            {filteredOrders.length > 0 ? (
                                filteredOrders.map((order) => {
                                    ...
                                    const formattedGstPercentage = order.gstPercentage;
                                    const formattedGstAmount = order.client.gstAmount;
                                    const formattedTotalAmountWithGST = order.totalAmountWithGST;
                                    ...
                                    return (
                                        <div className="order-group" key={order._id}>
                                                    ...
                                                    <div className="order-item-content" key={`${order._id}-${index}`}>
                                                        <div className="order-details">
                                                            ...
                                                            <div className="order-item-info">
                                                                ...
                                                                <div className="order-itemSizeDimensions">
                                                                    <div className='order-item-LeftContent'>Base Price</div>
                                                                    <div className='order-ItemColon'> : </div>
                                                                    <div className='order-item-detailSection'>
                                            ...
                                            {/* <div className="order-id" style={{alignContent:'center', textAlign:'center',  margin:'auto'}}> */}


                                                <div className="order-itemSizeDimensions order-itemGSTTotal">
                                                    <div className='order-item-LeftContent'> GST @ {formattedGstPercentage} % </div>
                                                    <div className='order-ItemColon'> : </div>
                                                    <div className='order-item-detailSection'>
                                                        {formatIndianCurrency(formattedGstAmount, true)}
                                                    </div>
                                                </div>

                                                  <div className="order-itemSizeDimensions order-itemGSTTotal  order-itemGSTTotal1">
                                                    <div className='order-item-LeftContent'> Total Amount </div>
                                                    <div className='order-ItemColon'> : </div>
                                                    <div className='order-item-detailSection'>
                                                        {formatIndianCurrency(formattedTotalAmountWithGST, true)}
                                                    </div>
                                                {/* </div> */}
