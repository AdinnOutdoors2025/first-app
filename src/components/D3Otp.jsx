...
//     //IF USER ENTER CORRECT OTP THEN GO TO THANK YOU PAGE
//   //  const navigate = useNavigate();
...
//                 <div className='OTP_msg1'>CHANGE NUMBER or Mail </div>                    <div>
...
//                     <div><input type="phone" maxLength={1}  className="Otp_entered"/></div>
//                     <div><input type="phone" maxLength={1}  className="Otp_entered"/></div>
//                         {/* <div className='Otp_enter'>1</div>
//                         <div className='Otp_enter'>2</div>
//                         <div className='Otp_enter'>3</div>
//                         <div className='Otp_enter'>4</div>
//                         <div className='Otp_enter'>5</div>
//                         <div className='Otp_enter'>6</div> */}
//                     </div>
//                     <span className='Otp_resends'>Resend OTP in 60 s</span>
//                     <button className="continue-btn1" onClick={()=>navigate("/thankyou")}>Verify</button>
