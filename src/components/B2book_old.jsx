...
//     // // Load dates for current product from localStorage
//     // useEffect(() => {
//     //     if (currentProduct?.id) {
//     //         const productId = currentProduct.id;
//     //         setCurrentProductId(productId);

//     //         // Load selected dates for this specific product
//     //         const savedSelected = localStorage.getItem(`selectedDates_${productId}`);
//     //         if (savedSelected) {
//     //             try {
...
//     //         // Load confirmed dates for this specific product
//     //         const savedConfirmed = localStorage.getItem(`confirmedDates_${productId}`);
//     //         if (savedConfirmed) {
//     //             try {
...
//     //                         end: new Date(parsed.end)
//     //                     });
//     //                     // Lock dates if confirmed dates exist
...
//     //                 }
//     //             } catch (e) {
//     //                 console.error('Error loading saved confirmed dates:', e);
//     //             }
//     //         } else {
//     //             setCampaignConfirmedDates({});
//     //             setAreDatesLocked(false);
...
//     //         const savedLockState = localStorage.getItem(`datesLocked_${productId}`);
//     //         if (savedLockState === 'true' && savedConfirmed) {
//     //             setAreDatesLocked(true);
//     //         }
//     //     }
//     // }, [currentProduct]);

//     // // Save dates to localStorage for current product
//     // useEffect(() => {
//     //     if (currentProductId && selectedDates.start && selectedDates.end && !areDatesLocked) {
//     //         localStorage.setItem(`selectedDates_${currentProductId}`, JSON.stringify({
//     //             start: selectedDates.start.toISOString(),
//     //             end: selectedDates.end.toISOString()
//     //         }));
//     //     } else if (currentProductId && !selectedDates.start) {
//     //         localStorage.removeItem(`selectedDates_${currentProductId}`);
//     //     }
//     // }, [selectedDates, currentProductId, areDatesLocked]);

//     // useEffect(() => {
//     //     if (currentProductId && campaignConfirmedDates.start && campaignConfirmedDates.end) {
//     //         localStorage.setItem(`confirmedDates_${currentProductId}`, JSON.stringify({
//     //             start: campaignConfirmedDates.start.toISOString(),
//     //             end: campaignConfirmedDates.end.toISOString()
//     //         }));
//     //         // Save lock state
//     //         localStorage.setItem(`datesLocked_${currentProductId}`, 'true');
//     //     } else if (currentProductId && !campaignConfirmedDates.start) {
//     //         localStorage.removeItem(`confirmedDates_${currentProductId}`);
//     //         localStorage.removeItem(`datesLocked_${currentProductId}`);
//     //     }
//     // }, [campaignConfirmedDates, currentProductId]);
...
//         if (currentProduct?.id) {
//             localStorage.removeItem(`pendingBookingAfterLogin_${currentProduct.id}`);
//             // localStorage.removeItem(`selectedDates_${currentProduct.id}`);
//             // localStorage.removeItem(`confirmedDates_${currentProduct.id}`);
//             // localStorage.removeItem(`datesLocked_${currentProduct.id}`);
//         }
...
//         // Clear localStorage for the new product (will be set when dates are selected)
//         if (mappedSpot.id) {
//             localStorage.removeItem(`pendingBookingAfterLogin_${mappedSpot.id}`);
//             // localStorage.removeItem(`selectedDates_${mappedSpot.id}`);
//             // localStorage.removeItem(`confirmedDates_${mappedSpot.id}`);
//             // localStorage.removeItem(`datesLocked_${mappedSpot.id}`);
//         }
...
//     // CONFIRM DATES FUNCTION - Called when user clicks "Reserve & Book" in calendar
//     const confirmDates = () => {
//         if (!selectedDates.start || !selectedDates.end) {
//             setCalendarErrorMessage("Please select start and end dates.");
//             return;
...
//         const pendingCount = getPendingDaysInRange(selectedDates.start, selectedDates.end);
//         const totalDays = getAvailableDaysInRange(selectedDates.start, selectedDates.end).length;
//         const totalPrice = totalDays * pricePerDay;
...
//         // // Show success message and close calendar
//         // setCalendarErrorMessage(
//         //     `✅ Dates confirmed! ${totalDays} days selected. Click "Book Now" to proceed to billing.`
//         // );
...
//                                     // disabled={isProcessingBooking || !hasConfirmedDates}
//                                     >
//                                         {isProcessingBooking ? "Processing..." : "Book Now"}
//                                     </button>
//                                     {/* {!hasConfirmedDates && hasSelectedDates && (
//                                         <small className="d-block text-muted mt-1" style={{ fontSize: "12px" }}>
//                                             *Click "Reserve & Book" in calendar to confirm dates
//                                         </small>
//                                     )} */}
//                                     <button
//                                         className=" mt-3 mb-2 btn-enquire2"
