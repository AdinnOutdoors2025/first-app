...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (location.state?.editOffProd) {
      setEditOffProd(location.state.editOffProd);
      setActiveMenu('OfferProduct'); // ✅ Automatically open 'OfferProduct' section
      setActiveOfferProducts(location.state.activeOfferProducts || 'Add Offers'); // 👈 This line sets tab to Add Products

      setTimeout(() => {
        const element = document.getElementById('EditOfferProduct');
        if (element) {
          element.scrollIntoView({ behavior: 'smooth' });
        }
      }, 100);
 ...
 {/* PRIME SPOTS ADD SECTION */}
          ...
          <div className={`adminHeadings ${activeMenu === 'EnquireUsers' ? 'active' : ''}`}
            ...
            <div className='sideImageHeading'>
              ...
              <i className="fa-solid fa-phone-volume adminHeading-imgsNew" ></i>
              Enquiry
            </div>
          ...
          <div className={`adminHeadings ${activeMenu === 'FooterContact' ? 'active' : ''}`}
            ...
            <div className='sideImageHeading'>
              ...
              <i class="fa-solid fa-address-card adminHeading-imgsNew adminHeading-imgsNew1" ></i>
              Contact
            </div>
                    ...
                    <div className='dashboardSummary ' key={summary.id}>
                      <div className="cards">
                        ...
                        <div className="content">
                          <div className="summaryHeading">{summary.summaryHeading}</div>
                          <div className="summaryCount">{summary.summaryCount}</div>
                        </div>
                      </div>
                    </div>
                  )
