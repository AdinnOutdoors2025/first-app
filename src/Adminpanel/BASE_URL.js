// export const baseUrl = "https://backend-bq11.onrender.com"; // Render platform Backend URL
// export const baseUrl = "http://localhost:3001"; // Local platform Backend URL
export const baseUrl = "http://142.93.213.3:3001"; // Digital Ocean platform Backend URL
// export const baseUrl = "http://192.168.0.159:3001";
export const gstPercentage = 18 //18% gst on each order of the product
export const whatsAppNumber = '917092558277'
// export const baseUrl = "https://backend-plum-two-80.vercel.app";
